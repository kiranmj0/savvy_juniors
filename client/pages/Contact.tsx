          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2 p-4">
              ...
              <div className="space-y-3">
                <div className="bg-primary/5 p-3 rounded-lg border border-primary/20 hover:bg-primary/10 transition-all">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href="tel:+971585800346" className="text-xs text-gray-700 hover:text-primary font-medium transition-colors">
                        +971 58 580 0346
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-xs text-gray-700 hover:text-primary font-medium transition-colors"
                      >
                ...
                <div className="bg-primary/5 p-3 rounded-lg border border-primary/20 hover:bg-primary/10 transition-all">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@savvyjuniors.ae" className="text-xs text-gray-700 hover:text-primary font-medium transition-colors">
                ...
                <div className="bg-green-50 p-3 rounded-lg border border-green-200 hover:bg-green-100 transition-all">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xs text-gray-700 hover:text-green-600 font-medium transition-colors"
                      >
                        +971 58 580 0346
                      </a>
                    </div>
            ...
            <div className="lg:col-span-3 bg-gradient-to-br from-white/80 to-primary/5 p-6 rounded-xl shadow-lg border border-primary/20 backdrop-blur-sm">
              {/* <div className="text-center mb-6">
                ...
                <p className="text-base text-gray-700">We'll get back to you as soon as possible</p>
              </div> */}
          ...
          <div className="bg-white rounded-t-3xl sm:rounded-2xl p-4 sm:p-8 w-full max-w-md shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              >
                ...
                <div className="text-left flex-1 min-w-0">
                  <div className="font-semibold text-gray-900 text-base sm:text-lg truncate">Submit via Website</div>
                  <div className="text-xs sm:text-sm text-gray-600">Send through our contact form</div>
                </div>
                {isSubmitting ? (
