...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl lg:max-w-none mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div
              id="about-image"
              data-animate
              className={`relative transition-all duration-1000 transform mt-8 md:mt-8 lg:mt-0 ${isVisible['about-image'] ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'
                }`}
            >
            ...
            >
              ...
              <Link
                to="/about"
                className="text-white hover:text-orange-300 inline-block px-2 py-2 rounded hover:bg-white hover:text-orange-500 hover:font-bold transition-all duration-300 font-semibold flex items-center gap-2 transition-all duration-300 inline-flex group animate-fade-in-up hover:gap-4 drop-shadow-sm"
      ...
      {/* Programs Section */}
      <section className="min-h-screen flex items-center bg-gradient-to-br from-secondary/5 to-primary/5 relative overflow-hidden py-20 md:py-0">
        ...
        <div className="max-w-7xl lg:max-w-none mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <Link
                to="/programs"
                className="text-primary hover:text-primary inline-block px-2 py-2 rounded hover:bg-primary hover:text-white hover:font-bold transition-all duration-300 font-semibold flex items-center gap-2 transition-all duration-300 inline-flex group animate-fade-in-up hover:gap-4 drop-shadow-sm"
